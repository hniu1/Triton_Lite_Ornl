...
#SBATCH -t 12:00:00
#SBATCH --array=1-40%8
#SBATCH -o ./slurm_output/stage1-sampling-index-%A_%a.out
#SBATCH -e ./slurm_output/stage1-sampling-index-%A_%a.err
...
CANDIDATES_PER_EVENT=${CANDIDATES_PER_EVENT:-5000}
OUTPUT_ROOT=${OUTPUT_ROOT:-processed_data/timestamp_stage1/m4_sampling_index}
