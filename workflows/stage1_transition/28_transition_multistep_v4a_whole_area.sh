...
#SBATCH --mem=96G
#SBATCH -t 02:00:00
#SBATCH -o ./slurm_output/stage1-transition-v4a-domain-%j.out
#SBATCH -e ./slurm_output/stage1-transition-v4a-domain-%j.err
...
python -u stage1_transition_whole_area.py \
  ...
  --output-dir results/stage1_transition_multistep_v4a/D030_whole_area_key_times \
