...
#SBATCH --mem=96G
#SBATCH -t 04:00:00
#SBATCH -o ./slurm_output/stage1-transition-v4b-rollout-%j.out
#SBATCH -e ./slurm_output/stage1-transition-v4b-rollout-%j.err
...
# Keep the established horizons and eligible-start cohort for comparison with
# earlier transition experiments and the operational promotion gate.
python -u stage1_transition_rollout.py \
  --run-dir results/stage1_transition_multistep_v4b \
  --checkpoint best_model.pt \
  --output-path results/stage1_transition_multistep_v4b/rollout_metrics.json \
