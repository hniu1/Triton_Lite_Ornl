...
#SBATCH --mem=96G
#SBATCH -t 06:00:00
#SBATCH -o ./slurm_output/stage1-transition-multistep-rollout-%j.out
#SBATCH -e ./slurm_output/stage1-transition-multistep-rollout-%j.err
...
python -u stage1_transition_rollout.py \
  ...
  --output-path results/stage1_transition_multistep_v1/rollout_metrics.json \
