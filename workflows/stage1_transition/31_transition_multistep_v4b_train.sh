...
#SBATCH --mem=96G
#SBATCH -t 06:00:00
#SBATCH -o ./slurm_output/stage1-transition-multistep-v4b-%j.out
#SBATCH -e ./slurm_output/stage1-transition-multistep-v4b-%j.err
...
python -u stage1_transition_multistep_v2_train.py \
  ...
  --output-dir results/stage1_transition_multistep_v4b \
