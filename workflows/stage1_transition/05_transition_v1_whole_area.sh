...
#SBATCH --mem=96G
#SBATCH -t 03:00:00
#SBATCH -o ./slurm_output/stage1-transition-domain-%j.out
#SBATCH -e ./slurm_output/stage1-transition-domain-%j.err
...
python -u stage1_transition_whole_area.py \
  ...
  --output-dir results/stage1_transition_v1_continued/D030_whole_area_key_times \
