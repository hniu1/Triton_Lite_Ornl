...
#SBATCH --mem=96G
#SBATCH -t 03:00:00
#SBATCH -o ./slurm_output/stage1-transition-multistep-v2-domain-%j.out
#SBATCH -e ./slurm_output/stage1-transition-multistep-v2-domain-%j.err
...
python -u stage1_transition_whole_area.py \
  ...
  --output-dir results/stage1_transition_multistep_v2/D030_whole_area_key_times \
