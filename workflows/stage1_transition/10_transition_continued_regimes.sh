...
#SBATCH --mem=96G
#SBATCH -t 06:00:00
#SBATCH -o ./slurm_output/stage1-transition-continued-regimes-%j.out
#SBATCH -e ./slurm_output/stage1-transition-continued-regimes-%j.err
...
python -u stage1_transition_regime_eval.py \
  --run-dir results/stage1_transition_v1_continued \
  --checkpoint best_model.pt \
  --output-path results/stage1_transition_v1_continued/regime_metrics.json \
