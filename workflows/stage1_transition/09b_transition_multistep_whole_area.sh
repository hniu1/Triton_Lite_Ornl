...
#SBATCH --mem=96G
#SBATCH -t 03:00:00
#SBATCH -o ./slurm_output/stage1-transition-multistep-domain-%j.out
#SBATCH -e ./slurm_output/stage1-transition-multistep-domain-%j.err
...
python -u stage1_transition_whole_area.py \
  --run-dir results/stage1_transition_multistep_v1 \
  --output-dir results/stage1_transition_multistep_v1/D030_whole_area_key_times \
